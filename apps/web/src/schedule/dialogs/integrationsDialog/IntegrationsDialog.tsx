        ...
        <div className="space-y-4">
          ...
          {oauthConfigured ? (
            <div className="p-4 border rounded-lg border-dashed">
              ...
              <div className="flex flex-col gap-2 mb-3 w-full sm:flex-row sm:items-center sm:gap-3">
                <Label className="text-sm sm:w-32">Default visibility:</Label>
                <Select
                  value={visibility}
                  onValueChange={(v) =>
                ...
                >
                  <SelectTrigger className="w-full sm:flex-1 h-8 text-sm">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
